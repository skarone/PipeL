...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Bitt Documentation","Pipeline","General Tools","Lighting","Animation","Rigging","Project Manager","Cache Manager","Animation To Lighting Workflow","Shading","Multi-Attribute","Rename Tools","References","Lighting Helper","Render Manager window","Playblast","BlendShapes Helper","Occ Render Rig Setup","WrapToSkinCluster","Copy Soft Weights to Joint","Control For Selection","Face Rigger","Eye Lids Rig Helper "," menu bar","Right Click Menu","Export Animation Data","Import Animation Data","Modeling Scene Check","Apply a New Value to group of nodes","Connect attributes between lists of nodes","Objects Tab","Objects Quality","toolBar"],
	DREX_NODE_LINKS: ["bitt_documentation.htm","pipeline.htm","general_tools.htm","lighting.htm","animation.htm","rigging.htm","project_manager.htm","cache_manager.htm","animation_to_lighting_workflow.htm","shading.htm","multi_attribute.htm","rename_tools.htm","references.htm","lighting_helper.htm","render_manager_window.htm","playblast.htm","blendshapes_helper.htm","occ_render_rig_setup.htm","wraptoskincluster.htm","copy_soft_weights_to_joint.htm","control_for_selection.htm","face_rigger.htm","eye_lids_rig_helper_.htm","_menu_bar.htm","right_click_menu.htm","export_animation_data.htm","import_animation_data.htm","modeling_scene_check.htm","apply_a_new_value_to_group_of_nodes.htm","connect_attributes_between_lists_of_nodes.htm","objects_tab.htm","objects_quality.htm","toolbar.htm"],
	DREX_NODE_CHILD_START: [1,6,10,13,15,16,23,25,25,27,28,30,30,30,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33],
	DREX_NODE_CHILD_END: [6,10,13,15,16,23,25,25,27,28,30,30,30,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33,33],
	DREX_MENU_TYPE: 1,
