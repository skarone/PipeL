...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Bitt Documentation","Pipeline","General Tools","Lighting","Project Manager","Cache Manager","Animation To Lighting Workflow","Multi-Attribute","Rename Tools","References","Tools"," menu bar","Right Click Menu","Export Animation Data","Import Animation Data","Apply a New Value to group of nodes","Connect attributes between lists of nodes","Lighting Helper","Objects Tab","Objects Quality","toolBar"],
	DREX_NODE_LINKS: ["bitt_documentation.htm","pipeline.htm","general_tools.htm","lighting.htm","project_manager.htm","cache_manager.htm","animation_to_lighting_workflow.htm","multi_attribute.htm","rename_tools.htm","references.htm","tools.htm","_menu_bar.htm","right_click_menu.htm","export_animation_data.htm","import_animation_data.htm","apply_a_new_value_to_group_of_nodes.htm","connect_attributes_between_lists_of_nodes.htm","lighting_helper.htm","objects_tab.htm","objects_quality.htm","toolbar.htm"],
	DREX_NODE_CHILD_START: [1,4,7,10,11,13,13,15,17,17,17,18,18,18,18,18,18,18,21,21,21],
	DREX_NODE_CHILD_END: [4,7,10,11,13,13,15,17,17,17,18,18,18,18,18,18,18,21,21,21,21],
	DREX_MENU_TYPE: 1,
