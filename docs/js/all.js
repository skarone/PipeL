...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Página principal","Pipeline","Project Manager","Cache Manager","Create Lighting Scene","Asset Right Click","Export Animation Data","Import Animation Data"],
	DREX_NODE_LINKS: ["index.htm","pipeline.htm","project_manager.htm","cache_manager.htm","create_lighting_scene.htm","asset_right_click.htm","export_animation_data.htm","import_animation_data.htm"],
	DREX_NODE_CHILD_START: [1,2,5,6,6,8,8,8],
	DREX_NODE_CHILD_END: [2,5,6,6,8,8,8,8],
	DREX_MENU_TYPE: 1,
