...
mc.menuItem( l = 'Rope Generator', c = "import maya.cmds as mc; mc.loadPlugin( 'ropeGenerator' );import modeling.ropeGenerator.ropeGenerator as rop; rop.createRopesForSelectedCurves()" )
